...
<body>
    ...
    <form action="">
        ...
        <div class="container col-8">
            ...
            <!-- Botones del inicio -->
            <c:choose>
                <c:when test='${poliza.getEstadopoliza().getId()==4}'>
                    <div class="row" style="display: flex; justify-content: space-between;">
                            ...
                            <div class="row" style="display: flex;">
                                <div class="col-3" style="height: 75%;">
                                    <button class="fw-bold form-control btn-action btn-lg" type="submit" name="accion"
                                        style="font-size: medium;" value="solicitarContratacionDeCobertura"
                                        formaction="no_funciona" formmethod="GET">
                                        Cancelar Poliza
                                    </button>
                                </div>
                                <div class="col-3">
                                ...
                                <div class="btn-group col-3" role="group">
                                    <button id="btnGroupDrop1" type="button"
                                        class="fw-bold form-control btn-action btn-lg" style="font-size: medium;"
                                        type="submit" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Historial
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                        <a class="dropdown-item" href="#">Pagos</a>
                                        <a class="dropdown-item" href="#">Vehiculo</a>
                                    </div>
                                </div>
                                <c:choose>
                                    <c:when test='${poliza.getPeriodo_pago().getIdperiodopago() > 0}'>
                                        <div class="col-3">
                                            <button class="fw-bold form-control btn-action btn-lg" type="submit"
                                                name="accion" style="font-size: medium;" value="solicitarRealizarPago"
                                                formaction="polizas" formmethod="POST">
                                                Pagar <br> Poliza
                                            </button>
                                        </div>
                                    </c:when>
                                    <c:when test='${poliza.getPeriodo_pago().getIdperiodopago() == 0}'>
                                        <div class="col-3">
                                            <button class="fw-bold form-control btn-action btn-lg" type="submit"
                                                name="accion" style="font-size: medium;"
                                                value="solicitarRealizarPrimerPago" formaction="polizas"
                                                formmethod="POST">
                        ...
                        <div class="col-4">
                            <div class="form-check form-switch" style="float:right;">
                                ...
                                <label class="form-check-label" for="flexSwitchCheckDefault">Renovación
                                    automatica</label>
                            </div>
                        </div>
                    </div>
